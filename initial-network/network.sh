...
function checkPrereqs() {
  ...
  infoln "*************function start CheckPrereqs()******************"
  ...
  infoln "*************function end CheckPrereqs()******************"
}
...
function createOrgs() {
  ...
  infoln "Generating CCP files for Hospital1 and Hospital2"
  ./organizations/ccp-generate.sh

  infoln "*************ending createOrgs()******************"
}
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker volume rm docker_orderer.example.com docker_peer0.hospital1.example.com docker_peer0.hospital2.example.com
...
# Using crpto vs CA. I have changed default to CA
...
CHANNEL_NAME="islamabadhospitalschannel"
